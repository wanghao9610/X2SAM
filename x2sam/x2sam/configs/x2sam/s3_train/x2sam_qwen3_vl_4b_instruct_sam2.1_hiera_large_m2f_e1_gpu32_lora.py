    ...
    *(
        [
            dict(
                ...
                image_task_names=image_infer_tasks if eval_data_type in ["image", "all"] else None,
                image_inputs=generation_image_inputs if eval_data_type in ["image", "all"] else None,
                video_task_names=video_infer_tasks if eval_data_type in ["video", "all"] else None,
