...
SHORT_QUESTIONS = [
    "Can you segment {sent} in this video? Please output the segmentation mask.",
    "Can you give the segmentation mask for {sent} in this video? Please respond with the segmentation mask.",
    "Can you highlight {sent} and output the corresponding segmentation mask? Please provide the segmentation mask.",
    "What is {sent} in this video? Please output the corresponding segmentation mask.",
    "What is {sent} in this video? Please generate a segmentation mask for this video.",
]

LONG_QUESTIONS = [
    "{sent} Please output the corresponding segmentation mask.",
    "{sent} Please generate a segmentation mask for this video.",
    "{sent} Please extract the segmentation mask.",
    "{sent} Please return the segmentation predictions as masks.",
    "{sent} Please segment the video.",
]
...
def vid_reaseg_conversations(labels, explain, is_sentences=[False], output_ids_with_output=True, cond_type="phrase"):
    questions = []
    answers = []
    ...
    for label, is_sentence in zip(labels, is_sentences):
...
def vid_reaseg_map_fn(
    example,
    output_ids_with_output=True,
    cond_type="phrase",
    video_token=None,
):
    messages = vid_reaseg_conversations(
        example["sampled_sents"],
        example.get("explain", None),
        example.get("is_sentences", [False]),
