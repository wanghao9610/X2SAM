...
SEG_QUESTIONS = [
    "Can you segment the video based on the following regions: {regions}? Please output the corresponding segmentation mask.",
    "Can you generate segmentation masks for this video based on the specified regions: {regions}? Please generate the segmentation masks.",
    "Can you provide segmentation masks for this video based on these regions: {regions}? Please provide the segmentation masks.",
    "Could you create segmentation masks for this video according to the specified regions: {regions}? Please create the segmentation masks.",
    "Could you output segmentation masks for this video that highlight the following regions: {regions}? Please output the segmentation masks.",
    "Could you provide segmentation masks for this video according to the specified regions: {regions}? Please respond with the segmentation masks.",
]
...
def obj_seg_conversations(regions, output_ids_with_output=True, cond_type="phrase"):
    questions = []
    answers = []
...
def vid_objseg_map_fn(
    example,
    output_ids_with_output=True,
    cond_type="phrase",
    video_token=None,
):
    messages = obj_seg_conversations(example["sampled_labels"], output_ids_with_output, cond_type)
    input = ""
    conversations = []
