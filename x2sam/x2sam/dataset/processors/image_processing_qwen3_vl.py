...
# refer to https://github.com/huggingface/transformers/blob/c12dfddba94c04fb6a5f5be4be879af51e354e2f/src/transformers/models/qwen2_vl/image_processing_qwen2_vl.py
"""Image processor class for Qwen3-VL."""
...
class Qwen3VLImageProcessor(BaseImageProcessor):
    r"""
    Constructs a Qwen3-VL image processor that dynamically resizes images based on the original images.
    ...
    def preprocess(
        ...
        if videos is not None:
            logger.warning(
                "`Qwen3VLImageProcessor` works only with image inputs and doesn't process videos anymore. "
