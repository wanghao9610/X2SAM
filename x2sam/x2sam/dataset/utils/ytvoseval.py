# reference: https://github.com/youtubevos/cocoapi/blob/master/PythonAPI/pycocotools/ytvoseval.py
...
class YTVOSeval:
    ...
    # Licensed under the Simplified BSD License [see coco2017/license.txt]
    ...
    def evaluate(self):
        ...
        self.ious = {(vidId, catId): computeIoU(vidId, catId) for vidId in p.vidIds for catId in catIds}
