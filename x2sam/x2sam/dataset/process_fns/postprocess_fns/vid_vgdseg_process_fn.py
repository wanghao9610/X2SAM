...
def vid_vgdseg_postprocess_fn(
    ...
    **kwargs,
    ...
    if sampled_labels is not None and isinstance(sampled_labels[0], list):
        sampled_labels = [sampled_labels[0] for _ in range(len(image_sizes))]
