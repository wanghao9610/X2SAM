...
from x2sam.dataset.collate_fns import default_collate_fn
from x2sam.model.modules.dispatch import SUPPORT_FLASH2
from x2sam.model.utils import LoadWoInit, find_all_linear_names, traverse_dict
    ...
    if cfg.get("framework", "mmengine").lower() == "huggingface":
        ...
        if args.deepspeed:
            ...
            if optim_wrapper in {"DeepSpeedOptimWrapper", "ModalityAwareDeepSpeedOptimWrapper"}:
                ...
                strategy = dict(
                    type=LazyObject("x2sam.engine", "DeepSpeedStrategy"),
                    config=ds_cfg,
