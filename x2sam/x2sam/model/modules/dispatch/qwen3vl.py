...
from x2sam.model.modules.dispatch.parallel.sequence.attention import (
    post_process_for_sequence_parallel_attn,
    pre_process_for_sequence_parallel_attn,
)
from x2sam.model.vlms.qwen3vl.modeling_qwen3_vl import apply_rotary_pos_emb, eager_attention_forward, repeat_kv
from x2sam.utils.dist import get_sequence_parallel_world_size


# modified from x2sam.model.vlms.qwen3vl.modeling_qwen3_vl.Qwen3VLTextAttention.forward
